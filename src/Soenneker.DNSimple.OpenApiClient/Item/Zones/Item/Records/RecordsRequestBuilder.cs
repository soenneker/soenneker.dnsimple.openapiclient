...
#nullable restore
        ...
        public async Task<global::Soenneker.DNSimple.OpenApiClient.Models.ListZoneRecords200Response> GetAsync(Action<RequestConfiguration<global::Soenneker.DNSimple.OpenApiClient.Item.Zones.Item.Records.RecordsRequestBuilder.RecordsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.DNSimple.OpenApiClient.Models.ListZoneRecords200Response>(requestInfo, global::Soenneker.DNSimple.OpenApiClient.Models.ListZoneRecords200Response.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Creates a new zone record.
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.DNSimple.OpenApiClient.Models.CreateZoneRecord201Response"/></returns>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Soenneker.DNSimple.OpenApiClient.Models.CreateZoneRecord201Response?> PostAsync(global::Soenneker.DNSimple.OpenApiClient.Models.ZoneRecordCreateRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.DNSimple.OpenApiClient.Models.CreateZoneRecord201Response> PostAsync(global::Soenneker.DNSimple.OpenApiClient.Models.ZoneRecordCreateRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.DNSimple.OpenApiClient.Models.CreateZoneRecord201Response>(requestInfo, global::Soenneker.DNSimple.OpenApiClient.Models.CreateZoneRecord201Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Lists the records for a zone.
        /// </summary>
...
#nullable restore
        ...
        {
#endif
            var requestInfo = new RequestInformation(Method.GET, "{+baseurl}/{account}/zones/{zone}/records{?name*,name_like*,sort*,type*}", PathParameters);
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.DNSimple.OpenApiClient.Models.ZoneRecordCreateRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.DNSimple.OpenApiClient.Models.ZoneRecordCreateRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
...
#endif
            if(ReferenceEquals(body, null)) throw new ArgumentNullException(nameof(body));
            var requestInfo = new RequestInformation(Method.POST, "{+baseurl}/{account}/zones/{zone}/records", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
...
#nullable restore
            ...
            [QueryParameter("sort")]
            public global::Soenneker.DNSimple.OpenApiClient.Models.SortZoneRecords? Sort { get; set; }
