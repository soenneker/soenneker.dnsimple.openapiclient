...
#nullable restore
        ...
        public async Task<global::Soenneker.DNSimple.OpenApiClient.Models.ListZoneRecords200> GetAsync(Action<RequestConfiguration<global::Soenneker.DNSimple.OpenApiClient.Item.Zones.Item.Records.RecordsRequestBuilder.RecordsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.DNSimple.OpenApiClient.Models.ListZoneRecords200>(requestInfo, global::Soenneker.DNSimple.OpenApiClient.Models.ListZoneRecords200.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
