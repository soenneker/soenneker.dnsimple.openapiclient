...
#nullable enable
        public async Task<global::Soenneker.DNSimple.OpenApiClient.Models.ListPushes200?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.DNSimple.OpenApiClient.Models.ListPushes200> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.DNSimple.OpenApiClient.Models.ListPushes200>(requestInfo, global::Soenneker.DNSimple.OpenApiClient.Models.ListPushes200.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// List pending pushes for the target account.
        /// </summary>
