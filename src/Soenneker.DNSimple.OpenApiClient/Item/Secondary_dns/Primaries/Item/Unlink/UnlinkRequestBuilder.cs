...
#nullable enable
        public async Task<global::Soenneker.DNSimple.OpenApiClient.Models.UnlinkPrimaryServer200Response?> PutAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.DNSimple.OpenApiClient.Models.UnlinkPrimaryServer200Response> PutAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.DNSimple.OpenApiClient.Models.UnlinkPrimaryServer200Response>(requestInfo, global::Soenneker.DNSimple.OpenApiClient.Models.UnlinkPrimaryServer200Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Unlink the primary server from a secondary zone.
        /// </summary>
